...
source_path = 's3://2301pt-mbd-predict-naomi-mangoejane-s3-source/moving_big_data/Stocks/'
save_path = "s3://2301pt-mbd-predict-naomi-mangoejane-s3-source/moving_big_data/data/Output/"
index_file_path = 's3://2301pt-mbd-predict-naomi-mangoejane-s3-source/moving_big_data/CompanyNames/top_companies.txt'
...
def save_table(dataframe, output_path, file_name, header):
    ...
    dataframe.to_csv(output_path + file_name + ".csv", index=False, header=True)
    #, header=False
